...
CREATE TABLE `paragraph` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `paragraph_ibfk_1` FOREIGN KEY (`id`) REFERENCES `passage` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
